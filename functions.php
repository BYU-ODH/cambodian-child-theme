...
function english_translation() {
	...
	while ( $mypod -> fetch() ) {
        ...
        echo '<li class="translated" id="no-bullets">' . '<a href="' . $permalink . '">' . $mypod->display('interviewee') . '</a>' . '</li>';
    }   
}
...
function video_interview() {
	...
	while ( $mypod -> fetch() ) {
		$id = $mypod -> field('id');
		$permalink = get_permalink($id);
        echo '<li class="video" id="no-bullets">' . '<a href="' . $permalink . '">' . $mypod->display('interviewee') . '</a>' . '</li>';
    }   
}
